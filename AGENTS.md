...
- **Generated by**: `scripts/gen-icons.py` (uses Pillow). Run from repo root: `.venv\Scripts\python.exe scripts\gen-icons.py`. Re-run if `frontend/public/logo.png` changes.
