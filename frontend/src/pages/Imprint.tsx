    ...
    <div className="min-h-screen bg-slate-900 text-slate-100">
      <div className="max-w-2xl mx-auto px-4 md:px-6 py-6">
        ...
        <div className="space-y-4 text-slate-300 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-slate-100 pt-4">{t('imprint.disclaimer_title')}</h2>

          <p>{t('imprint.disclaimer_body_1')}</p>

          <p>{t('imprint.disclaimer_body_2')}</p>

          <h2 className="text-xl font-semibold text-slate-100 pt-4">{t('imprint.liability_title')}</h2>

          <p>{t('imprint.liability_body')}</p>

          <h2 className="text-xl font-semibold text-slate-100 pt-4">{t('imprint.copyright_title')}</h2>
