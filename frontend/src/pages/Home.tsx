          ...
          <div className="lg:w-2/5 flex flex-col">
            ...
            <div className="flex gap-2 mb-2">
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg bg-slate-700 border border-slate-600 hover:bg-slate-600 disabled:opacity-50 transition-colors"
              >
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-1">
                  {savedLocations.map((loc, i) => {
                    ...
                    const tone = i === 0
                      ? 'bg-emerald-900/40 border-emerald-700 text-emerald-300 hover:border-emerald-600'
                        ...
                        {isEditing ? (
                          <>
                            <input
                              ...
                              className="px-2 py-1 bg-transparent text-slate-100 placeholder-slate-500 outline-none w-32"
                            />
                            <button
            ...
            {location && (
              <div className="hidden lg:block">
                <p className="text-sm text-slate-400 mb-3">
                  <span className="font-medium text-slate-200">{locationName || `${location.lat.toFixed(4)}, ${location.lng.toFixed(4)}`}</span>
                  {' '}{t('home.selected')}
                </p>
                <button
